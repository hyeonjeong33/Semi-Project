...
<!-- Search -->	
	<div class="div_top_search">
		<form id="searchform" action="eventController.do" onsubmit="return false;" method="post">
				...
				<table class="table_board">
					...
					<tbody class="real">
						...
						<tr>
							...
							<td><a href="../eventController.do?command=selectone&board_postnum=<%=list.get(i).getBoard_postnum()%>"><%=list.get(i).getBoard_title()%></a></td>
					...
					<tbody class="page">
						<tr>
							...
							<% if (pg > 1) { //처음, 이전 링크%> 
							  ...
							  [<a href="event_boardlist.jsp?pg=<%=pg - 1%>">◀</a>] 
							<% } else { %> 
