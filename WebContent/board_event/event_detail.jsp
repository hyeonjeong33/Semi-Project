...
<jsp:include page="../common/hippe_header.jsp"></jsp:include>
	...
	<div class="div_top_title">
		...
		<h3 class="title mb-lg-5 mb-md-4 mb-sm-4 mb-3 text-center">이벤트게시판</h3>
	</div>
		<div class="content">
		...
		<table class="table_board">
			...
			<div id ="btn">
				<input type="button" value="글 목록" onclick="location.href='eventController.do?command=eventlist'" >
				<c:choose>
				<c:when test="${id eq dto.writer}">
				<input type="button" value="수  정" onclick="location.href='eventController.do?command=updateform&postnum=<jsp:getProperty property="board_postnum" name="dto"/>'"/>
				<input type="button" value="삭  제" onclick="location.href='eventController.do?command=delete&postnum=<jsp:getProperty property="board_postnum" name="dto"/>'"/>
				</c:when>
				</c:choose>
