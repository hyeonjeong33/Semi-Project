		...
		window.addEventListener('load', function () {
			naverLogin.getLoginStatus(function (status) {
				if (status) {
					...
					var member_id = email.split('@')[0];
					
					$(".test").html("<form action='../loginController.do' id='sub_form' method='post'>"+
					...
					/* window.location.replace("http://" + window.location.hostname + ( (location.port==""||location.port==undefined)?"":":" + location.port) + "/KakaoPay_test/index.jsp"); */
				} else {
